...
class TestImages(TestCase):
  ...
  def setUp(self):
    ...
    '''
    self.test_user = User(username = 'Ian')
    self.test_user.save()
    self.image = Image(image = 'Ian.jpeg',name = 'Ian',caption = 'Ian',user = self.test_user)
  ...
  def test_delete_image(self):
    self.image2 = Image(image = 'wanarua.jpeg',name = 'wanarua',caption = 'wanarua',user = self.test_user)
